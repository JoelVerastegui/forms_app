...
void main() {
  ...
  setUp(() {
    widget = const MaterialApp(home: BlocCounterScreen());
    counter = CounterBloc().state.counter;
    transactionCount = CounterBloc().state.transactionCount;
  });
  ...
  group('Components Tests', () {
    ...
    testWidgets('BlocProvider<CounterBloc> exists', (tester) async {
      await tester.pumpWidget(widget);
